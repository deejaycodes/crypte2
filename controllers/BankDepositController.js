                ...
                .then(userUpdated => {
                    ...
                    .then(updatedDeposit => {
                        Deposits.create({
                            ...
                            .then(deposit => {
                                req.flash('success', "Bank Deposit approved");
                                res.redirect("back");
                            })
                            .catch(error => {
                                req.flash('error', "Server error!");
                ...
                .then(userUpdated => {
                    ...
                    .then(updatedDeposit => {
                        Deposits.create({
                            ...
                            .then(deposit => {
                                req.flash('success', "Bank Deposit disapproved");
                                res.redirect("back");
                            })
                            .catch(error => {
                                req.flash('error', "Server error!");
        ...
        if (err) {
            ...
            if (amount.length < 1) {
                ...
                BankDeposits.create({
                    ...
                    .then(deposit => {
                        req.flash('success', "Bank Deposit uploaded, awaiting confirmation!");
                        res.redirect("back");
                    })
                    .catch(error => {
                        req.flash('error', "Error creating bank deposit!");
                        res.redirect("back");
                    });
            }
        }
